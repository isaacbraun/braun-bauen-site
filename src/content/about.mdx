...
Collaborating closely with designer and developers on the Calcite Design System team to
communicate and test foundational design and global components.
Utilizing **HTML**, **CSS**, and **TypeScript** to bring greater consistency, functionality, and flexibility to the system,
allowing cusomters to easily craft engaging and consistent user experiences in Esri's products and user community.
</ResumeItem>
